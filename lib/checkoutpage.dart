...
class CheckOutPage extends StatefulWidget {
  ...
  const CheckOutPage({Key? key,required this.total, required this.user})
      : super(key: key);
                      ...
                      child: Column(
                        children: [
                          ...
                          Container(
                            ...
                            width: 300,
                            child: Text(
                                "Pickup time daily from 10.00 A.M to 6.00 P.M from our store. Please allow 15-30 minutes to prepare your order before pickup time"),
                          ),
                          Row(
                            children: [
                    ...
                    onPressed: () async {
                      Navigator.of(context).pop();
                       Order order = new Order(
                            widget.user.user_email, _phone, _name, widget.total.toString());
                      await Navigator.of(context).push(
                        MaterialPageRoute(
                          builder: (context) => PayScreen(order: order),
                        ),
                      );
                    },
                  ),
