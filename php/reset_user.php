...
function sendEmail($otp,$newpassword,$user_email){
    ...
    $to = $user_email;
    $subject = "From All-Out Groceries. Please reset your password";
    ...
    <a href='https://javathree99.com/s269926/alloutgroceries/php/verify_account.php?email=".$user_email."&key=".$otp."'>Click Here to reactivate your account</a>";
